...
class RestaurantSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $restaurant->name = "Mc Donald's";
        $restaurant->address = "Via delle Rose 32";
        $restaurant->email = "mcdonadls@mc.com";
        ...
        $restaurant = new Restaurant;
        $restaurant->name = "Fujian Bambù";
        $restaurant->address = "Via delle Ninfee 22";
        $restaurant->email = "fujianbambu@gmail.com";
